...
def add_song(playlist, song):
    ...
    # add the new song to the playlist by appending 
    # include song in the append function
...
def search_by_artist(playlist, artist_name):
    pass
    # create an empty list new_playlist[]
    artist_song_list = []
    # for loop to search for each artist
    for song in playlist:
      if artist_name == song['artist']:
        artist_song_list.append(song['title'])
    # if artist name matches
    # append the name of the song in new_playlist
...
def search_by_title(playlist, song_title):
    ...
    # for song in playlist:
    # #check if song_title matches song['title]']
    #   if song['title'] == song_title:
    # # append song title to the empty list:
