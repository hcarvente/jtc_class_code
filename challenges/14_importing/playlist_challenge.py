...
add_song(my_playlist, {'artist': 'Farruko', 'title': 'La Toxica'})
add_song(my_playlist, {'artist': 'Yeison Jimenez', 'title': 'Aventurero'})
display_playlist(my_playlist)
...
total_tracks = get_playlist_length(my_playlist)
print(total_tracks)
