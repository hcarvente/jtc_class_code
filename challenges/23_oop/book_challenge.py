...
my_library.add(title = 'My Grandmother\'s Hand', author = 'Resmaa Menakem')
...
nyt_bestsellers.add(title = 'The Return', author = 'Nicholas Sparks')
nyt_bestsellers.add(title = 'White Fragility', author = 'Robin DiAngelo')
