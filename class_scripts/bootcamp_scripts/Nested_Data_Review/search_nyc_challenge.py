...
for parks in borough:
    if 'parks' in borough:
        print(f'This borough has beautiful parks!')
    else:
        print(f'Sorry! This borough does not have parks')
        break
...
for borough in nyc:
    ...
    if 'beaches' in borough:
        # since we know beaches exist because this is true
        for beach in borough['beaches']:
            # beach
            print('\t' + "beach:" + beach['name'])
    if 'parks' in borough:
        for park in borough['parks']:
            print('\t' + 'park:' + park['name'])
